...
# Python uses a newline character to separate statements. It places each
# statement on one line.
# However, a long statement can span multiple lines by using the blackslash (\)
# character.


# Identifiers
# Identifiers are names that identify variables, functions, modules, classes,
...
# (''') and triple-double quotes (""") to denote a single literal.
s = 'This is a string'
print(s)
