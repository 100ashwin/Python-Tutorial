...
# However, the input() function returns a string, not an integer or any other data type.

# for example what if you want to perform operation on input values of integer so for that you can use int() function. or any other data type function which you need.
# for example:
